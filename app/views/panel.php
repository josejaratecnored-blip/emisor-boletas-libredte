<?php $pestana = 'boletas'; require __DIR__ . '/encabezado.php'; ?>
  ...
  <div class="card">
    ...
    <div class="scroll">
    <table>
      <thead><tr><th>Folio</th><th>Fecha</th><th class="num">Total</th><th>Estado SII</th><th>Acciones</th><th>Nota de crédito</th></tr></thead>
      <tbody>
      ...
      <?php endforeach; ?>
      <?php if (!$boletas): ?><tr><td colspan="6" style="color:var(--muted)">Aún no hay boletas.</td></tr><?php endif; ?>
      </tbody>
    </table>
    </div>
  </div>
